...
namespace StreamChat.Core.InternalDTO.Events
{
    ...
    internal partial class AIIndicatorUpdateEventInternalDTO
    {
        [Newtonsoft.Json.JsonProperty("ai_message", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string AiMessage { get; set; }

        [Newtonsoft.Json.JsonProperty("ai_state", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public string Type { get; set; } = "ai_indicator.update";
