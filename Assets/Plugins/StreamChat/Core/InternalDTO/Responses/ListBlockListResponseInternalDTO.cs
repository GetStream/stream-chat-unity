...
namespace StreamChat.Core.InternalDTO.Responses
{
    ...
    internal partial class ListBlockListResponseInternalDTO
    {
        ...
        public System.Collections.Generic.List<BlockListResponseInternalDTO> Blocklists { get; set; } = new System.Collections.Generic.List<BlockListResponseInternalDTO>();
