...
namespace StreamChat.Core.InternalDTO.Responses
{
    ...
    internal partial class MessageResponseInternalDTO
    {
        ...
        [Newtonsoft.Json.JsonConverter(typeof(StreamChat.Core.Serialization.EnumeratedStructConverter<MessageResponseTypeInternalDTO>))]
        public MessageResponseTypeInternalDTO Type { get; set; }
