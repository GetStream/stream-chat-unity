...
namespace StreamChat.Core.InternalDTO.Responses
{
    ...
    internal partial class MessageWithChannelResponseInternalDTO
    {
        ...
        [Newtonsoft.Json.JsonConverter(typeof(StreamChat.Core.Serialization.EnumeratedStructConverter<MessageWithChannelResponseTypeInternalDTO>))]
        public MessageWithChannelResponseTypeInternalDTO Type { get; set; }
