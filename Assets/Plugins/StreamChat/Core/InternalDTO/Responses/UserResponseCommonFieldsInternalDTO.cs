...
namespace StreamChat.Core.InternalDTO.Responses
{
    ...
    internal partial class UserResponseCommonFieldsInternalDTO
    {
        [Newtonsoft.Json.JsonProperty("avg_response_time", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("teams_role", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.Dictionary<string, string> TeamsRole { get; set; }
