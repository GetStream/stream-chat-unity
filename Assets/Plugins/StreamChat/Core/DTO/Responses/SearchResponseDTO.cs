...
namespace StreamChat.Core.DTO.Responses
{
    ...
    internal partial class SearchResponseDTO
    {
        /// <summary>
        ...
        public System.Collections.Generic.List<SearchResultDTO> Results { get; set; }
        ...
        public SearchWarningDTO ResultsWarning { get; set; }
