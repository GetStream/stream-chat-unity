...
{
    public class OwnUser : User, ILoadableFrom<OwnUserInternalDTO, OwnUser>, ILoadableFrom<OwnUserResponseInternalDTO, OwnUser>
    {
        ...
        OwnUser ILoadableFrom<OwnUserResponseInternalDTO, OwnUser>.LoadFromDto(OwnUserResponseInternalDTO dto)
        {
            Banned = dto.Banned;
            ChannelMutes = ChannelMutes.TryLoadFromDtoCollection(dto.ChannelMutes);
            CreatedAt = dto.CreatedAt;
